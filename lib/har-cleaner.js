...
exports.sanitizeHar = exports.defaultMimeTypesList = exports.defaultResponseHeadersList = exports.defaultQueryPostParamsList = exports.defaultCookiesList = exports.defaultRequestHeadersList = void 0;
// Default list for request headers that are commonly known to contain sensitive information.
exports.defaultRequestHeadersList = [
    "Authorization",
    "client_id",
    "client_secret",
    "auth",
...
exports.defaultQueryPostParamsList = [
    "SAMLRequest",
    "SAMLResponse",
    "code",
    "code_challenge",
...
exports.defaultResponseHeadersList = [
...
function sanitizeHar(har, options) {
    ...
    const effectiveOptions = {
        ...
        scrubSpecificHeader: (options === null || options === void 0 ? void 0 : options.scrubSpecificHeader) || exports.defaultRequestHeadersList,
        scrubSpecificCookie: (options === null || options === void 0 ? void 0 : options.scrubSpecificCookie) || exports.defaultCookiesList,
        scrubSpecificQueryParam: (options === null || options === void 0 ? void 0 : options.scrubSpecificQueryParam) || exports.defaultQueryPostParamsList,
        scrubSpecificPostParam: (options === null || options === void 0 ? void 0 : options.scrubSpecificPostParam) || exports.defaultQueryPostParamsList,
        scrubSpecificResponseHeader: (options === null || options === void 0 ? void 0 : options.scrubSpecificResponseHeader) || exports.defaultResponseHeadersList,
    };
